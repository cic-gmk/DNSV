...
def getStartAndEnd(start,end):
    ...
    return start,end
def judgeNeighbour(bench_SVs,home_pos,compared_sv_chrom,compared_sv_start,compared_sv_end,compared_sv_type,typeignore,refdist=200,overlap_rate=0.5):
    flag = 0
...
def judgeIfSame(data_1,data_2,refdist,typeignore,overlap_rate,i):
    ...
    if data_1_sv_chrom in data_2.index:
        flag = judgeNeighbour(data_2,data_1_sv_start,data_1_sv_chrom,data_1_sv_start,data_1_sv_end,data_1_sv_type,typeignore,refdist,overlap_rate)
        if data_1_sv_type != 'INS' and flag == 0:
            flag = judgeNeighbour(data_2,data_1_sv_end,data_1_sv_chrom,data_1_sv_start,data_1_sv_end,data_1_sv_type,typeignore,refdist,overlap_rate)
...
#                 continue
            flag = judgeIfSame(data_1,data_2,refdist,typeignore,overlap_rate,i)
            if flag ==1:
...
if __name__ == '__main__':
    #overlap
    compareTwo(file_name_1=r'sniffles_AJfather_filtered_repeat.csv',\
                file_name_2=r'sniffles_AJson_filtered_repeat.csv',\
                out_dir = r'sniffles_AJfatherson_filtered_repeat_overlap.csv',\
