...
#     flag_2=0
    if sv_type == 'INS':
        ...
        if start_max <= end_min:
            flag_1 = 1
#             if end_min - start_max >=100:
#                 flag_2 = 1
    return flag_1
def getStartAndEnd(start,end):
    start,end = min(start,end),max(start,end)
    return start,end
def judgeNeighbour(bench_SVs,home_pos,compared_sv_chrom,compared_sv_start,compared_sv_end,compared_sv_type,typeignore,refdist):
    flag = 0
...
def judgeIfSame(data_1,data_2,refdist,typeignore,i):
    ...
    if data_1_sv_chrom in data_2.index:
        flag = judgeNeighbour(data_2,data_1_sv_start,data_1_sv_chrom,data_1_sv_start,data_1_sv_end,data_1_sv_type,typeignore,refdist)
        if data_1_sv_type != 'INS' and flag == 0:
            flag = judgeNeighbour(data_2,data_1_sv_end,data_1_sv_chrom,data_1_sv_start,data_1_sv_end,data_1_sv_type,typeignore,refdist)
